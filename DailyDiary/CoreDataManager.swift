...
//                    self.addTestData()
    ...
    private func addTestData() {
        ...
        newItem.date         = dateFormatter.dateFromString("April 3, 1892 06:22 PM")
        ...
        newItem.imageData    = UIImagePNGRepresentation(UIImage.init(named: "camera")!)
        newItem.location     = ""
        
        newItem2.date        = dateFormatter.dateFromString("April 4, 1892 08:22 PM")
        ...
        newItem2.imageData   = UIImagePNGRepresentation(UIImage.init(named: "camera")!)
        newItem2.location    = ""
        
        newItem3.date        = dateFormatter.dateFromString("April 5, 1892 08:22 PM")
        newItem3.text        = "Two shoulders of mutton arrived, Carrie having arranged with another butcher without consulting me.  Gowing called, and fell over scraper coming in.  Must get that scraper removed."
        newItem3.imageData   = nil
        newItem3.location    = ""
        
        newItem4.date        = dateFormatter.dateFromString("April 6, 1892 08:22 PM")
        ...
        newItem5.date        = dateFormatter.dateFromString("April 7, 1892 08:22 PM")
        ...
        newItem5.imageData   = UIImagePNGRepresentation(UIImage.init(named: "camera")!)
        newItem5.location    = ""
        
        newItem6.date        = dateFormatter.dateFromString("April 8, 1892 08:22 PM")
        ...
        newItem6.imageData   = UIImagePNGRepresentation(UIImage.init(named: "grid")!)
        newItem6.location    = ""
        
        newItem7.date        = dateFormatter.dateFromString("April 9, 1892 08:22 PM")
        ...
        newItem7.imageData   = UIImagePNGRepresentation(UIImage.init(named: "list")!)
        newItem7.location    = ""
        
        newItem8.date        = dateFormatter.dateFromString("April 10, 1892 08:22 PM")
        ...
        newItem8.imageData   = UIImagePNGRepresentation(UIImage.init(named: "camera")!)
        newItem8.location    = ""
